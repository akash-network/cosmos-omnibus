...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v1.2.10-jackal-v4.5.0`|
...
Polkachu also provide pruned snapshots for Jackal. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
