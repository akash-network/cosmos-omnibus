...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v1.2.45-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v1.2.45-generic
    env:
...
|---|---|---|---|
|[akash](https://github.com/akash-network/node)|`v2.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-akash-v2.1.0`|[Example](./akash)|
|[archway](https://github.com/archway-network/archway)|`v9.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-archway-v9.0.0`|[Example](./archway)|
|[assetmantle](https://github.com/AssetMantle/node)|`v1.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-assetmantle-v1.0.0`|[Example](./assetmantle)|
|[atomone](https://github.com/atomone-hub/atomone)|`v3.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-atomone-v3.3.0`|[Example](./atomone)|
|[axelar](https://github.com/axelarnetwork/axelar-core)|`v1.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-axelar-v1.2.1`|[Example](./axelar)|
|[babylon](https://github.com/babylonlabs-io/babylon.git)|`v2.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-babylon-v2.1.0`|[Example](./babylon)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.5.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-bandchain-v2.5.3`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v4.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-bitcanna-v4.0.3`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.21.6`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-bitsong-v0.21.6`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.3.2`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-bostrom-v0.3.2`|[Example](./bostrom)|
|[canto](https://github.com/Canto-Network/Canto)|`v8.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-canto-v8.1.1`|[Example](./canto)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`0.6.9`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-cheqd-0.6.9`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v9.0.6`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-chihuahua-v9.0.6`|[Example](./chihuahua)|
|[coreum](https://github.com/tokenize-x/tx-chain)|`v7.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-coreum-v7.0.0`|[Example](./coreum)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v27.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-cosmoshub-v27.4.0`|[Example](./cosmoshub)|
...
|[gitopia](https://github.com/gitopia/gitopia)|`v5.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-gitopia-v5.1.0`|[Example](./gitopia)|
|[gravitybridge](https://github.com/Gravity-Bridge/Gravity-Bridge)|`v1.11.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-gravitybridge-v1.11.1`|[Example](./gravitybridge)|
|[impacthub](https://github.com/ixofoundation/ixo-blockchain)|`v0.18.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-impacthub-v0.18.1`|[Example](./impacthub)|
|[injective](https://github.com/InjectiveLabs/injective-chain-releases)|`v1.15.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-injective-v1.15.0`|[Example](./injective)|
|[intento](https://github.com/trstlabs/intento)|`v1.1.0-hotfix.13`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-intento-v1.1.0-hotfix.13`|[Example](./intento)|
|[irisnet](https://github.com/irisnet/irishub)|`v3.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-irisnet-v3.1.1`|[Example](./irisnet)|
|[jackal](https://github.com/JackalLabs/canine-chain)|`v5.1.2`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-jackal-v5.1.2`|[Example](./jackal)|
|[juno](https://github.com/CosmosContracts/Juno)|`v29.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-juno-v29.0.0`|[Example](./juno)|
|[kava](https://github.com/Kava-Labs/kava)|`v0.25.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-kava-v0.25.0`|[Example](./kava)|
|[kichain](https://github.com/KiFoundation/ki-tools)|`5.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-kichain-5.0.1`|[Example](./kichain)|
|[konstellation](https://github.com/konstellation/konstellation)|`v0.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-konstellation-v0.5.0`|[Example](./konstellation)|
|[kujira](https://github.com/Team-Kujira/core)|`v2.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-kujira-v2.0.0`|[Example](./kujira)|
|[kyve](https://github.com/KYVENetwork/chain)|`v2.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-kyve-v2.2.0`|[Example](./kyve)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v4.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-likecoin-v4.2.0`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.6.7`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-lumnetwork-v1.6.7`|[Example](./lumnetwork)|
|[migaloo](https://github.com/White-Whale-Defi-Platform/migaloo-chain)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-migaloo-v5.0.0`|[Example](./migaloo)|
|[neutron](https://github.com/neutron-org/neutron)|`v6.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-neutron-v6.0.0`|[Example](./neutron)|
...
|[passage](https://github.com/envadiv/Passage3D)|`v4.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-passage-v4.0.1`|[Example](./passage)|
...
|[sei](https://github.com/sei-protocol/sei-chain)|`v5.7.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-sei-v5.7.5`|[Example](./sei)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-sentinel-v0.11.5`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.11.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-shentu-v2.11.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-sifchain-v1.4.0`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-sommelier-v4.0.2`|[Example](./sommelier)|
|[source](https://github.com/Source-Protocol-Cosmos/source)|`v3.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-source-v3.0.1`|[Example](./source)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v16.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-stargaze-v16.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v29.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-stride-v29.1.1`|[Example](./stride)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v2.0.6`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-teritori-v2.0.6`|[Example](./teritori)|
|[terpnetwork](https://github.com/terpnetwork/terp-core)|`v5.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-terpnetwork-v5.0.3`|[Example](./terpnetwork)|
|[terra](https://github.com/terra-money/core)|`v2.11.8`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-terra-v2.11.8`|[Example](./terra)|
|[umee](https://github.com/umee-network/umee)|`v6.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-umee-v6.3.0`|[Example](./umee)|
|[xpla](https://github.com/xpladev/xpla)|`v1.8.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.45-xpla-v1.8.0`|[Example](./xpla)|
