...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v0.3.23-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v0.3.23-generic
    env:
...
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v1.5.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-bitcanna-v1.5.3`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.12.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-bitsong-v0.12.0`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.3.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-bostrom-v0.3.2`|[Example](./bostrom)|
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-cerberus-v3.1.0`|[Example](./cerberus)|
...
|[comdex](https://github.com/comdex-official/comdex)|`v8.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-comdex-v8.1.1`|[Example](./comdex)|
...
|[dig](https://github.com/notional-labs/dig)|`v3.3.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-dig-v3.3.1`|[Example](./dig)|
|[emoney](https://github.com/e-money/em-ledger)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-emoney-v1.2.0`|[Example](./emoney)|
|[empowerchain](https://github.com/empowerchain/empowerchain)|`v0.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-empowerchain-v0.0.3`|[Example](./empowerchain)|
|[evmos](https://github.com/evmos/evmos)|`v11.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-evmos-v11.0.2`|[Example](./evmos)|
|[fetchhub](https://github.com/fetchai/fetchd)|`v0.10.6`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-fetchhub-v0.10.6`|[Example](./fetchhub)|
|[gravitybridge](https://github.com/Gravity-Bridge/Gravity-Bridge)|`v1.7.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-gravitybridge-v1.7.2`|[Example](./gravitybridge)|
...
|[kava](https://github.com/Kava-Labs/kava)|`v0.21.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-kava-v0.21.0`|[Example](./kava)|
...
|[kujira](https://github.com/Team-Kujira/core)|`v0.7.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-kujira-v0.7.1`|[Example](./kujira)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v3.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-likecoin-v3.1.1`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.2.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-lumnetwork-v1.2.2`|[Example](./lumnetwork)|
|[mars](https://github.com/mars-protocol/hub.git)|`v1.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-mars-v1.0.0`|[Example](./mars)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v0.8.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-omniflixhub-v0.8.0`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v14.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-osmosis-v14.0.0`|[Example](./osmosis)|
|[panacea](https://github.com/medibloc/panacea-core)|`v2.0.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-panacea-v2.0.5`|[Example](./panacea)|
|[passage](https://github.com/envadiv/Passage3D)|`v1.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-passage-v1.1.0`|[Example](./passage)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v3.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-persistence-v3.2.0`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-regen-v5.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.4.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-rizon-v0.4.1`|[Example](./rizon)|
|[seinetwork](https://github.com/sei-protocol/sei-chain)|`1.2.2beta-postfix`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-seinetwork-1.2.2beta-postfix`|[Example](./seinetwork)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.9.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-sentinel-v0.9.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-shentu-v2.5.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.1.0-beta`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-sifchain-v1.1.0-beta`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-sommelier-v4.0.2`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v8.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-stargaze-v8.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v5.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-stride-v5.1.1`|[Example](./starname)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v1.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-teritori-v1.3.0`|[Example](./teritori)|
|[umee](https://github.com/umee-network/umee)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-umee-v3.1.0`|[Example](./umee)|
|[vidulum](https://github.com/vidulum/mainnet)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.23-vidulum-v1.2.0`|[Example](./vidulum)|
