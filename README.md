...
services:
  node:
    ...
    env:
      ...
      # - PROJECT_DIR=.akash
      # - PROJECT_BIN=akash
      # - BINARY_URL=https://github.com/akash-network/node/releases/download/v2.0.0/akash_linux_amd64.zip
      # - BINARY_ZIP_PATH=build/akash-v2.0.0 # only required if expected binary file isn't in the ZIP root
```
...
|---|---|---|---|
|[akash](https://github.com/akash-network/node)|`v2.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.41-akash-v2.0.0`|[Example](./akash)|
...
```bash
./update-project-version.sh mychainname v2.0.0 v1.3.0
```
