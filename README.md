...
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v2.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.19-cerberus-v2.0.1`|[Example](./cerberus)|
...
|[comdex](https://github.com/comdex-official/comdex)|`v7.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.19-comdex-v7.0.0`|[Example](./comdex)|
...
|[evmos](https://github.com/evmos/evmos)|`v9.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.19-evmos-v9.1.0`|[Example](./evmos)|
...
|Project|Version|Image| |
|---|---|---|---|
|[evmos](https://github.com/evmos/evmos)|`v9.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.19-evmos-v9.1.0-skip`|[Example](./evmos)|
