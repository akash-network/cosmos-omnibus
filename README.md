...
Image URL: `ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-generic`

```yaml
services:
  node:
    image: ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-agoric-agoric-3.1`|[Example](./agoric)|
|[akash](https://github.com/ovrclk/akash)|`v0.16.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-akash-v0.16.3`|[Example](./akash)|
...
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v1.4.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-bitcanna-v1.4.1`|[Example](./bitcanna)|
...
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v2.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-cerberus-v2.0.0`|[Example](./cerberus)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`v0.5.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-cheqd-v0.5.0`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v2.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-chihuahua-v2.1.0`|[Example](./chihuahua)|
|[chronicnetwork](https://github.com/ChronicNetwork/cht)|`v1.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-chronic-v1.1.0`|[Example](./chronic)|
|[comdex](https://github.com/comdex-official/comdex)|`v0.1.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-comdex-v0.1.1`|[Example](./comdex)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v7.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-cosmoshub-v7.0.2`|[Example](./cosmoshub)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v0.7.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-cronos-v0.7.0`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v3.3.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.6-cryptoorgchain-v3.3.3`|[Example](./cryptoorgchain)|
...
|[empowerchain](https://github.com/empowerchain/empowerchain)|`v0.0.1`|`ghcomnibus:v0.3.6smos-omnibus:v0.3.5-empowerchain-v0.0.1`|[Example](./empowerchain)|
|[evmos](https://github.com/tharsis/evmos)|`v8.2.0`|`ghcr.io/ovrclk/cosmos-omnibomnibus:v0.3.6s-v8.2.0`|[Example](./evmos)|
|[fetchhub](https://github.com/fetchai/fetchd)|`v0.10.4`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.5-fetcomnibus:v0.3.6[Example](./fetchhub)|
|[gravitybridge](https://github.com/Gravity-Bridge/Gravity-Bridge)|`v1.4.1`|`ghcr.io/ovrclk/cosomnibus:v0.3.6.3.5-gravitybridge-v1.4.1`|[Example](./gravitybridge)|
|[impacthub](https://github.com/ixofoundation/ixo-blockchain)|`v0.17.0`|`ghcr.iomnibus:v0.3.6s-omnibus:v0.3.5-impacthub-v0.17.0`|[Example](./impacthub)|
|[irisnet](https://github.com/irisnet/irishub)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-omnomnibus:v0.3.6isnet-v1.0.1`|[Example](./irisnet)|
|[juno](https://github.com/CosmosContracts/Juno)|`v10.0.2`|`ghcr.io/ovrclk/comnibus:v0.3.6v0.3.5-juno-v10.0.2`|[Example](./juno)|
|[kava](https://github.com/Kava-Labs/kava)|`v0.16.1`|`ghcr.io/ovrclk/cosmos-omnibus:vomnibus:v0.3.616.1`|[Example](./kava)|
|[kixchain](https://github.com/KiFoundation/ki-tools)|`3.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3omnibus:v0.3.6.0`|[Example](./kichain)|
|[konstellation](https://github.com/konstellation/konstellation)|`v0.5.0`|`ghcromnibus:v0.3.6mos-omnibus:v0.3.5-konstellation-v0.5.0`|[Example](./konstellation)|
|[kujira](https://github.com/Team-Kujira/core)|`v0.6.0`|`ghcr.io/ovrclk/cosmos-omnibus:vomnibus:v0.3.60.6.0`|[Example](./kujira)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v3.0.0`|`ghcr.io/ovrclk/cosomnibus:v0.3.6.3.5-likecoin-v3.0.0`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.0.5`|`ghcr.io/ovrclk/cosmos-omniomnibus:v0.3.6network-v1.0.5`|[Example](./lumnetwork)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v0.4.1`|`ghcr.io/ovrclk/cosmomnibus:v0.3.63.5-omniflixhub-v0.4.1`|[Example](./omniflixhub)|
...
|[panacea](https://github.com/medibloc/panacea-core)|`v2.0.2`|`ghcr.io/ovrclk/cosomnibus:v0.3.6.3.5-panacea-v2.0.2`|[Example](./panacea)|
|[passage](https://github.com/envadiv/Passage3D)|`v1.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.5-paomnibus:v0.3.6[Example](./passage)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v0.1.3`|`ghcr.io/ovrcomnibus:v0.3.6bus:v0.3.5-persistence-v0.1.3`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v4.0.0`|`ghcr.io/ovrclomnibus:v0.3.6us:v0.3.5-regen-v4.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.2.8`|`ghcr.io/ovrclk/cosmos-omnibus:v0.3.omnibus:v0.3.6`|[Example](./rizon)|
|[seinetwork](https://github.com/sei-protocol/sei-chain)|`1.2.2beta`|`ghcr.io/ovrclk/comnibus:v0.3.6v0.3.5-seinetwork-1.2.2beta`|[Example](./seinetwork)|
...
|[shentu](https://github.com/certikfoundation/shentu)|`v2.2.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0omnibus:v0.3.6.2.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.0-beta.12-issuefix`|`ghcr.io/oomnibus:v0.3.6mnibus:v0.3.5-sifchain-v1.0-beta.12-issuefix`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v3.1.0`|`ghcr.io/ovrclk/cosmos-omnibomnibus:v0.3.6elier-v3.1.0`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v5.0.0`|`ghcr.io/ovrclk/cosomnibus:v0.3.6.3.5-stargaze-v5.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.10.18`|`ghcr.io/ovrclk/cosmomnibus:v0.3.63.5-starname-v0.10.18`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v1.0.2`|`ghcr.io/ovrclk/cosmos-omnibusomnibus:v0.3.6-v1.0.2`|[Example](./starname)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v1.1.2`|`ghcr.io/ovrcomnibus:v0.3.6bus:v0.3.5-teritori-v1.1.2`|[Example](./teritori)|
|[umee](https://github.com/umee-network/umee)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-oomnibus:v0.3.6umee-v1.0.1`|[Example](./umee)|
