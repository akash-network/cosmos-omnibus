...
|[evmos](https://github.com/evmos/evmos)|`v16.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-evmos-v16.0.2`|[Example](./evmos)|
...
|[injective](https://github.com/InjectiveLabs/injective-chain-releases)|`v1.12.1-1705909076`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-injective-v1.12.1-1705909076`|[Example](./injective)|
...
|[jackal](https://github.com/JackalLabs/canine-chain)|`v3.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-jackal-v3.1.1`|[Example](./jackal)|
...
|[nois](https://github.com/noislabs/noisd)|`v1.0.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-nois-v1.0.5`|[Example](./nois)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v2.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-omniflixhub-v2.0.0`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v22.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-osmosis-v22.0.0`|[Example](./osmosis)|
...
|[stride](https://github.com/Stride-Labs/stride)|`v17.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.4.5-stride-v17.0.0`|[Example](./stride)|
