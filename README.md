...
|---|---|---|---|
|[akash](https://github.com/akash-network/node)|`v0.36.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.7-akash-v0.36.0`|[Example](./akash)|
...
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v9.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.7-chihuahua-v9.0.1`|[Example](./chihuahua)|
...
|[cosmoshub](https://github.com/cosmos/gaia)|`v22.3.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.7-cosmoshub-v22.3.1`|[Example](./cosmoshub)|
...
|[jackal](https://github.com/JackalLabs/canine-chain)|`v4.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.7-jackal-v4.4.0`|[Example](./jackal)|
...
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v5.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.7-omniflixhub-v5.1.0`|[Example](./omniflixhub)|
