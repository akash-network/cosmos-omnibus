...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v0.3.26-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v0.3.26-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-upgrade-7-2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-agoric-agoric-upgrade-7-2`|[Example](./agoric)|
|[akash](https://github.com/akash-network/node)|`v0.20.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-akash-v0.20.0`|[Example](./akash)|
|[assetmantle](https://github.com/AssetMantle/node)|`v0.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-assetmantle-v0.3.0`|[Example](./assetmantle)|
|[autonomy](https://github.com/AutonomyNetwork/autonomy-chain)|`v1.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-autonomy-v1.2.1`|[Example](./autonomy)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.3.6`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-bandchain-v2.3.6`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v1.5.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-bitcanna-v1.5.3`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.12.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-bitsong-v0.12.0`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.3.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-bostrom-v0.3.2`|[Example](./bostrom)|
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-cerberus-v3.1.0`|[Example](./cerberus)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`0.6.9`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-cheqd-0.6.9`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v4.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-chihuahua-v4.2.1`|[Example](./chihuahua)|
|[comdex](https://github.com/comdex-official/comdex)|`v9.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-comdex-v9.1.0`|[Example](./comdex)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v9.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-cosmoshub-v9.0.0`|[Example](./cosmoshub)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v0.8.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-cronos-v0.8.2`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v4.2.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-cryptoorgchain-v4.2.2`|[Example](./cryptoorgchain)|
|[decentr](https://github.com/Decentr-net/decentr)|`v1.6.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-decentr-v1.6.0`|[Example](./decentr)|
|[defund](https://github.com/defund-labs/defund)|`v0.1.0-alpha`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-defund-v0.1.0-alpha`|[Example](./defund)|
|[desmos](https://github.com/desmos-labs/desmos)|`v2.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-desmos-v2.4.0`|[Example](./desmos)|
|[dig](https://github.com/notional-labs/dig)|`v3.3.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-dig-v3.3.1`|[Example](./dig)|
|[emoney](https://github.com/e-money/em-ledger)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-emoney-v1.2.0`|[Example](./emoney)|
|[empowerchain](https://github.com/empowerchain/empowerchain)|`v0.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-empowerchain-v0.0.3`|[Example](./empowerchain)|
|[evmos](https://github.com/evmos/evmos)|`v12.0.0-rc4`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-evmos-v12.0.0-rc4`|[Example](./evmos)|
...
|[injective](https://github.com/InjectiveLabs/injective-chain-releases)|`v1.10.0-1679065799`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-injective-v1.10.0-1679065799`|[Example](./injective)|
...
|[jackal](https://github.com/JackalLabs/canine-chain)|`v1.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-jackal-v1.2.1`|[Example](./jackal)|
...
|[kujira](https://github.com/Team-Kujira/core)|`v0.8.4-mainnet`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-kujira-v0.8.4-mainnet`|[Example](./kujira)|
...
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v15.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-osmosis-v15.0.0`|[Example](./osmosis)|
...
|[passage](https://github.com/envadiv/Passage3D)|`v1.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-passage-v1.1.0`|[Example](./passage)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v3.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-persistence-v3.2.0`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-regen-v5.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.4.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-rizon-v0.4.1`|[Example](./rizon)|
|[seinetwork](https://github.com/sei-protocol/sei-chain)|`1.2.2beta-postfix`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-seinetwork-1.2.2beta-postfix`|[Example](./seinetwork)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.9.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-sentinel-v0.9.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-shentu-v2.5.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.1.0-beta`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-sifchain-v1.1.0-beta`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-sommelier-v4.0.2`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v8.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-stargaze-v8.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v7.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-stride-v7.0.0`|[Example](./stride)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v1.3.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-teritori-v1.3.1`|[Example](./teritori)|
|[umee](https://github.com/umee-network/umee)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-umee-v3.1.0`|[Example](./umee)|
|[vidulum](https://github.com/vidulum/mainnet)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-vidulum-v1.2.0`|[Example](./vidulum)|
...
|Project|Version|Image| |
|---|---|---|---|
|[evmos](https://github.com/evmos/evmos)|`v12.0.0-rc4`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-evmos-v12.0.0-rc4-skip`|[Example](./evmos)|
|[juno](https://github.com/CosmosContracts/Juno)|`v13.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.26-juno-v13.0.0-skip`|[Example](./juno)|
