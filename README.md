...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v0.3.31-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v0.3.31-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-upgrade-7-2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-agoric-agoric-upgrade-7-2`|[Example](./agoric)|
|[akash](https://github.com/akash-network/node)|`v0.20.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-akash-v0.20.0`|[Example](./akash)|
|[assetmantle](https://github.com/AssetMantle/node)|`v0.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-assetmantle-v0.3.0`|[Example](./assetmantle)|
...
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v4.2.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-chihuahua-v4.2.2`|[Example](./chihuahua)|
|[comdex](https://github.com/comdex-official/comdex)|`v10.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-comdex-v10.0.0`|[Example](./comdex)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v9.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-cosmoshub-v9.1.0`|[Example](./cosmoshub)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v0.8.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-cronos-v0.8.2`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v4.2.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-cryptoorgchain-v4.2.2`|[Example](./cryptoorgchain)|
|[decentr](https://github.com/Decentr-net/decentr)|`v1.6.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-decentr-v1.6.0`|[Example](./decentr)|
|[defund](https://github.com/defund-labs/defund)|`v0.1.0-alpha`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-defund-v0.1.0-alpha`|[Example](./defund)|
|[desmos](https://github.com/desmos-labs/desmos)|`v2.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-desmos-v2.4.0`|[Example](./desmos)|
...
|[injective](https://github.com/InjectiveLabs/injective-chain-releases)|`v1.10.0-1679065799`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-injective-v1.10.0-1679065799`|[Example](./injective)|
|[irisnet](https://github.com/irisnet/irishub)|`v2.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-irisnet-v2.0.1`|[Example](./irisnet)|
...
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v3.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-likecoin-v3.1.1`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-lumnetwork-v1.4.0`|[Example](./lumnetwork)|
|[mars](https://github.com/mars-protocol/hub.git)|`v1.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-mars-v1.0.0`|[Example](./mars)|
|[migaloo](https://github.com/White-Whale-Defi-Platform/migaloo-chain)|`v2.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-migaloo-v2.0.2`|[Example](./migaloo)|
|[neutron](https://github.com/neutron-org/neutron)|`v1.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-neutron-v1.0.1`|[Example](./neutron)|
|[nois](https://github.com/noislabs/noisd)|`v1.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-nois-v1.0.2`|[Example](./nois)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v0.10.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-omniflixhub-v0.10.0`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v15.1.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-osmosis-v15.1.2`|[Example](./osmosis)|
|[panacea](https://github.com/medibloc/panacea-core)|`v2.0.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-panacea-v2.0.5`|[Example](./panacea)|
|[passage](https://github.com/envadiv/Passage3D)|`v1.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-passage-v1.1.0`|[Example](./passage)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v3.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-persistence-v3.2.0`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v5.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-regen-v5.1.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.4.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-rizon-v0.4.1`|[Example](./rizon)|
|[seinetwork](https://github.com/sei-protocol/sei-chain)|`1.2.2beta-postfix`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-seinetwork-1.2.2beta-postfix`|[Example](./seinetwork)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.9.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-sentinel-v0.9.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-shentu-v2.5.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.1.0-beta`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-sifchain-v1.1.0-beta`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-sommelier-v4.0.2`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v8.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-stargaze-v8.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v9.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-stride-v9.0.1`|[Example](./stride)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v1.3.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-teritori-v1.3.1`|[Example](./teritori)|
|[umee](https://github.com/umee-network/umee)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-umee-v3.1.0`|[Example](./umee)|
|[vidulum](https://github.com/vidulum/mainnet)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.31-vidulum-v1.2.0`|[Example](./vidulum)|
