...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v1.2.13-babylon-v1.0.1`|
...
Polkachu also provide pruned snapshots for Babylon Genesis. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
