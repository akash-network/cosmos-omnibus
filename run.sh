...
[ -n "$PRUNING_INTERVAL" ] && export PRUNING_INTERVAL="--pruning-interval ${PRUNING_INTERVAL}"
[ -n "$PRUNING_KEEP_EVERY" ] && export PRUNING_KEEP_EVERY="--pruning-keep-every ${PRUNING_KEEP_EVERY}"
[ -n "$PRUNING_KEEP_RECENT" ] && export PRUNING_KEEP_RECENT="--pruning-keep-recent ${PRUNING_KEEP_RECENT}"
