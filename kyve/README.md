...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v1.2.11-kyve-v2.0.0`|
...
Polkachu also provide pruned snapshots for KYVE. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
