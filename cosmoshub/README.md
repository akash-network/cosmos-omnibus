...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v0.4.33-cosmoshub-v21.0.0`|
...
Polkachu also provide pruned snapshots for Cosmos Hub. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
