...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v1.2.12-decentr-v1.6.4`|
...
Polkachu also provide pruned snapshots for Decentr. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
