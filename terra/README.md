...
|Image|`ghcr.io/akash-network/cosmos-omnibus:v1.2.10-terra-v2.11.8`|
...
Polkachu also provide pruned snapshots for Terra Classic. Find the [latest snapshot](https://polkachu.com/tendermint_snapshots/akash) and apply it using the `SNAPSHOT_URL` variable.
